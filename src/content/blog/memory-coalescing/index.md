...
Once you know the failure mode, the classic fixes all become 1 idea: *reshape the access so that the warp's 32 addresses are contiguous when they hit DRAM, and absorb any awkward stride somewhere cheaper.*
...
- A warp's load is judged by how many 32-byte sectors its 32 addresses cover, and 4 sectors per request is ideal for fp32. A large stride pushes it to 32, an 8x traffic amplification you can compute by hand before ever profiling.
