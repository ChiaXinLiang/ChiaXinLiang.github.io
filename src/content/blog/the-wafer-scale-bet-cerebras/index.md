...
**Power and packaging.** 1 wafer-scale chip draws on the order of 20 kW, so the CS-3 pairs it with a water-cooled cold plate and a custom mounting system that absorbs the thermal-expansion mismatch between a silicon wafer and the board it presses against. Delivering ~20,000 amps at low voltage into a single part is its own engineering subplot.
