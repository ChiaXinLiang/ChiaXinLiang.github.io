...
![Concept overview: How Big a Batch Before Decode Becomes Compute-Bound?](./section-overview.png)
...
![Deep dive: A smaller model makes the timing example feasible](./deep-dive-component-03.png)
...
![Deep dive: Add cache traffic to the crossing](./deep-dive-component-04.png)
