...
$542 million. That is the figure International Business Strategies (IBS) attached to designing a single 5nm chip back in 2018. By 2023 the same firm was quoting $725 million for 2nm. Those numbers are estimates, they are contested, and analysts have argued a disciplined team can come in far lower. But even the skeptics' numbers sit north of $100 million. Every dollar of it is spent before the first working chip exists.

This is the strangest economic fact about the semiconductor industry: the product costs a fortune to create and almost nothing to copy. Once the design is done and the masks are made, each additional good chip adds wafer, yield-loss, packaging, and test expense. That recurring cost can be substantial for large accelerators. Everything interesting about the business falls out of that 1 asymmetry. It decides who can afford to build chips, why old process nodes never die, and why hyperscalers design their own accelerators while everyone else buys.
...
A **mask set** is the stack of quartz-and-chrome (or, for EUV, reflective multilayer) plates the fab uses to pattern each layer of the chip. A leading-edge process needs 70 to 80 of them. They are made to order for your design and useless for anyone else's.
...
Nothing about the physics got cheaper. The mask set for that shuttle still cost what mask sets cost; the wafer still ran through the same fab. What changed is the denominator: hundreds of designs sharing 1 set of fixed costs. They share it on a mature node where those fixed costs are thousands of times lower than at 2nm. Tiny Tapeout is the amortization equation run in reverse. That it lands at pizza-money prices is the cleanest proof that chip cost was never really about the silicon.
