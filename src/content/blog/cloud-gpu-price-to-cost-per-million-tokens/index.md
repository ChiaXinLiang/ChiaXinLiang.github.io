...
![Concept overview: From Cloud GPU Price to Cost per Million Tokens](./section-overview.png)
...
![Deep dive: Use useful aggregate output throughput](./deep-dive-component-03.png)
...
![Deep dive: Fleet occupancy changes the result](./deep-dive-component-04.png)
