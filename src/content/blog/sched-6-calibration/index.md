...
Conformalized Quantile Regression [\[1\]](https://arxiv.org/abs/1905.03222), published in 2019, combines fitted quantiles with calibration residuals under exchangeability. Adaptive Conformal Inference Under Distribution Shift [\[2\]](https://arxiv.org/abs/2106.00170), published in 2021, adapts the miscoverage level online and studies long-run coverage. This article applies their statistical boundaries to the duration and wait estimates in `sched-4` and `sched-5`; the numerical examples are illustrative.
...
- [\[1\]](https://arxiv.org/abs/1905.03222) Conformalized Quantile Regression (2019)
- [\[2\]](https://arxiv.org/abs/2106.00170) Adaptive Conformal Inference Under Distribution Shift (2021)
